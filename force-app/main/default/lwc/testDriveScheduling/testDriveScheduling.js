...
/***************************************************/
    ...
    @wire(getRecord, { recordId: '$recordId', fields: ['Opportunity.Customer__r.PersonContactId','Opportunity.DSE_MSPIN__c','Opportunity.Dealership__c','Opportunity.DMS_Enquiry_Name__c','Opportunity.Customer__c','Opportunity.Line_Of_Business__c', 'Opportunity.Dealership__r.Channel__c'] })
    wiredOpportunity({ error, data }) {
        ...
        if (data) {
            ...
            if(this.record.fields.Dealership__r){
                this.dealershipChannel = this.record.fields.Dealership__r.value.fields.Channel__c.value;
                console.log('== dealershipChannel ', this.dealershipChannel);
            }
...
findVariants()
{
    findVariant({searchVar:this.selectedVariant, channel : this.dealershipChannel})
    .then(result => {
