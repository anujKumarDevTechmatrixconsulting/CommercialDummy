...
export default class SummaryScreen extends Base {
    ...
    loyalty_Tax; 
    connectedCallback() {
        this.setData({ addSchemes: { isCommercial : 
            (this.state.opportunityInfo.dealerChannel && 
                (this.state.opportunityInfo.dealerChannel === 'COM' || 
                this.state.opportunityInfo.dealerChannel === 'NRC')) ? true : false } });
    ...
    */
    conditionalConnectedCallBack() {
        ...
        this.offersSubTotal = this.state.addSchemes.OfferData + 
                ...
                (this.state.addSchemes.isCommercial ? this.state.addSchemes.acquisitionDiscount : 0) +
                (this.state.addSchemes.isCommercial ? this.state.addSchemes.loyaltyDiscount : 0);
