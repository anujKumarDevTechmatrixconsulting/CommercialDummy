...
const defaults = {
    ...
    addComponent : null,
    addAccessories : null,
    opportunityInfo : { Name : '', Pricebook2Id : '', Email__c : '',  Mobile__c : '', StageName : '', Amount : 0, Model_Code__c : '', Variant_Modified_Count__c : 0, Old_Variant__c : null, forCode : '', regionCode : '', billingState : '', dealerForCodeId: '', dealerChannel: ''},
